...
// Get student_id and spreadsheet_id from URL parameters
...
try {
    // Get spreadsheet and folder info
    ...
    // Get student info
    $sql = "SELECT * FROM students WHERE id = :student_id AND spreadsheet_id = :spreadsheet_id";
    if($stmt = $conn->prepare($sql)) {
        ...
        if($stmt->rowCount() == 0) {
            header("location: spreadsheet.php?id=" . $spreadsheet_id);
            exit;
        }
...
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <h2>Attendance Records for <?= htmlspecialchars($student_name) ?></h2>
        <a href="manage_attendance.php?spreadsheet_id=<?= $spreadsheet_id ?>" class="btn btn-primary">
            <i class="bi bi-calendar-check"></i> Manage Class Attendance
        </a>
    </div>
    ...
    <div class="student-info-card mb-4">
        <div class="row">
            <div class="col-md-6">
                ...
                <p class="mb-1"><strong>Name:</strong> <?= htmlspecialchars($student_name) ?></p>
                <p class="mb-0"><strong>ID:</strong> <?= htmlspecialchars($student_number) ?></p>
            </div>
            <div class="col-md-6 text-md-end">
                <p class="mb-1"><strong>Class:</strong> <?= htmlspecialchars($spreadsheet_name) ?></p>
